...
interface Bundle {
     ...
     */
    val entries: Sequence<Pair<Property<*, *, *>, Any?>>
     ...
     */
    fun <Read : Any, Write : Read> delete(permission: Write, property: Property<*, Read, Write>)

    /**
     * Deletes the value of the given [property] from this bundle.
     * @throws NoSuchElementException if the given [property] is not associated with any value
     */
    fun delete(property: Property<*, Any, Any>)
}